                            ...
                            <div className="flex items-center gap-4 bg-white/5 rounded-full px-4 py-1.5 border border-white/5">
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        e.preventDefault();
                                        onUpdateQuantity(item._id || item.id, -1, item.selectedSize);
                                    }}
                ...
                <div className="mt-auto space-y-4 relative z-20">
                        ...
                        <div className="text-right">
                            <div className="flex flex-col items-end">
                                ...
                                {item.originalPrice > item.price && (
                                    <div className="flex items-center gap-2 mt-1">
                                        <span className="text-[11px] text-gray-500 line-through font-mono">₹{item.originalPrice}</span>
                                        <span className="text-[9px] font-mono text-accent font-black bg-accent/10 px-1 rounded">
                    ...
                    <div 
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            e.preventDefault();
                        }} // Prevent navigation when clicking anywhere in the controls area
                    >
