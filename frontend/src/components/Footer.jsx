            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-xs font-bold uppercase tracking-widest text-gray-500">
                        <li><Link to="/shop" className="hover:text-primary transition-all">All Inventory</Link></li>
                        <li><Link to="/shop" className="hover:text-primary transition-all">Digital Skins</Link></li>
