    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center px-6 py-24 max-w-4xl mx-auto text-center">
                ...
                {/* ENDURA Logo */}
                <div className="footer-logo mb-16">
                    <h1 className="text-5xl md:text-7xl font-oswald tracking-[0.3em] uppercase text-white">
                        ENDURA
                    </h1>
                    <div className="mt-4 h-px w-32 bg-gradient-to-r from-transparent via-accent to-transparent mx-auto opacity-40" />
                </div>

                {/* Closing Line */}
                <p className="closing-line text-white/60 font-light text-sm md:text-base tracking-[0.8em] uppercase mb-20 leading-loose max-w-2xl">
                ...
                <button
                    ...
                    className="ritual-cta group relative px-12 py-4 border border-accent/30 text-accent font-mono text-xs tracking-[0.5em] uppercase transition-all duration-700 hover:border-accent/60 hover:shadow-[0_0_30px_rgba(212,175,55,0.3)]"
                >
                ...
                {/* Divider */}
                <div className="my-20 w-full max-w-xs h-px bg-gradient-to-r from-transparent via-white/5 to-transparent" />
            ...
            <div className="system-status absolute bottom-8 right-8 text-right font-mono text-[9px] text-white/10 tracking-[0.3em] uppercase leading-relaxed">
                SESSION TERMINATED<br />
                ARCHIVE SEALED<br />
                IDENTITY SYNC COMPLETE
            </div>

            {/* System Status (Bottom Left Corner) */}
            <div className="system-status absolute bottom-8 left-8 font-mono text-[9px] text-white/10 tracking-[0.3em] uppercase leading-relaxed">
