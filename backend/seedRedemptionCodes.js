...
const batch3Codes = [
    { serialNumber: 1, code: "END-P34K-E2Y" }, { serialNumber: 2, code: "END-BULW-SBN" }, { serialNumber: 3, code: "END-0HFH-XGX" }, { serialNumber: 4, code: "END-BG0V-L88" }, { serialNumber: 5, code: "END-K5JB-8CL" },
    { serialNumber: 6, code: "END-W8J9-871" }, { serialNumber: 7, code: "END-J7NW-G0D" }, { serialNumber: 8, code: "END-P8U3-ZY4" }, { serialNumber: 9, code: "END-XBSB-9PO" }, { serialNumber: 10, code: "END-FKNU-FQP" },
    { serialNumber: 11, code: "END-8Y0G-BW5" }, { serialNumber: 12, code: "END-J9CS-2MN" }, { serialNumber: 13, code: "END-4IYW-OW5" }, { serialNumber: 14, code: "END-LJAO-4A3" }, { serialNumber: 15, code: "END-KO3Z-Q8T" },
    { serialNumber: 16, code: "END-0MFH-GW6" }, { serialNumber: 17, code: "END-TYMA-Y5P" }, { serialNumber: 18, code: "END-7F0B-D2Z" }, { serialNumber: 19, code: "END-1PVN-OFI" }, { serialNumber: 20, code: "END-X7GU-L9D" },
    { serialNumber: 21, code: "END-C1X7-759" }, { serialNumber: 22, code: "END-HUDO-0MC" }, { serialNumber: 23, code: "END-ZHRI-QIL" }, { serialNumber: 24, code: "END-3LJO-6EJ" }, { serialNumber: 25, code: "END-G232-C0O" },
    { serialNumber: 26, code: "END-ZENK-274" }, { serialNumber: 27, code: "END-4O0Z-FCJ" }, { serialNumber: 28, code: "END-NT9L-77H" }, { serialNumber: 29, code: "END-IC9U-DKF" }, { serialNumber: 30, code: "END-AJY8-3CO" },
    { serialNumber: 31, code: "END-1066-MZ4" }, { serialNumber: 32, code: "END-S09S-HNI" }, { serialNumber: 33, code: "END-S61E-LOA" }, { serialNumber: 34, code: "END-N9JP-I44" }, { serialNumber: 35, code: "END-P1AT-ZLA" },
    { serialNumber: 36, code: "END-XOLY-R1R" }, { serialNumber: 37, code: "END-RUEQ-GQX" }, { serialNumber: 38, code: "END-XQLA-3AG" }, { serialNumber: 39, code: "END-KF0K-ZPU" }, { serialNumber: 40, code: "END-LBAJ-EZE" },
    { serialNumber: 41, code: "END-TMOB-8IQ" }, { serialNumber: 42, code: "END-J0GB-E67" }, { serialNumber: 43, code: "END-WVWE-D5A" }, { serialNumber: 44, code: "END-L1OY-K2I" }, { serialNumber: 45, code: "END-UGBB-8JY" },
    { serialNumber: 46, code: "END-CRO2-157" }, { serialNumber: 47, code: "END-ACTF-KT9" }, { serialNumber: 48, code: "END-ILEO-FQF" }, { serialNumber: 49, code: "END-JK2M-ZW4" }, { serialNumber: 50, code: "END-IHQI-SA1" },
    { serialNumber: 51, code: "END-SH1V-8HG" }, { serialNumber: 52, code: "END-SLYF-801" }, { serialNumber: 53, code: "END-1NB2-P1E" }, { serialNumber: 54, code: "END-HJSR-W56" }, { serialNumber: 55, code: "END-DDZK-UXS" },
    { serialNumber: 56, code: "END-NX5A-C4T" }, { serialNumber: 57, code: "END-KC9U-PHM" }, { serialNumber: 58, code: "END-SOSI-FC5" }, { serialNumber: 59, code: "END-S11Z-SCB" }, { serialNumber: 60, code: "END-T52F-FVZ" },
    { serialNumber: 61, code: "END-0N5Z-NYH" }, { serialNumber: 62, code: "END-B9YY-PT8" }, { serialNumber: 63, code: "END-G2HM-NPF" }, { serialNumber: 64, code: "END-QJF0-TV2" }, { serialNumber: 65, code: "END-0SPT-UYN" },
    { serialNumber: 66, code: "END-KRMV-08K" }, { serialNumber: 67, code: "END-4ORC-6XN" }, { serialNumber: 68, code: "END-K3ZK-XA7" }, { serialNumber: 69, code: "END-IKDL-BJR" }, { serialNumber: 70, code: "END-UID7-J2O" },
    { serialNumber: 71, code: "END-QMQ2-187" }, { serialNumber: 72, code: "END-R88O-6GX" }, { serialNumber: 73, code: "END-J1C6-BUI" }, { serialNumber: 74, code: "END-MSTB-AV2" }, { serialNumber: 75, code: "END-PLUL-9K3" },
    { serialNumber: 76, code: "END-WG75-LQC" }, { serialNumber: 77, code: "END-TCRV-ER4" }, { serialNumber: 78, code: "END-M6UK-4EV" }, { serialNumber: 79, code: "END-8CKV-N1H" }, { serialNumber: 80, code: "END-OFTV-HEH" },
    { serialNumber: 81, code: "END-70LA-FHT" }, { serialNumber: 82, code: "END-8MZS-2PN" }, { serialNumber: 83, code: "END-OCUR-BMA" }, { serialNumber: 84, code: "END-JXN4-EJQ" }, { serialNumber: 85, code: "END-J56V-RN4" },
    { serialNumber: 86, code: "END-UUDQ-MJQ" }, { serialNumber: 87, code: "END-QCON-J8X" }, { serialNumber: 88, code: "END-TMF7-MXG" }, { serialNumber: 89, code: "END-ZD1U-4SE" }, { serialNumber: 90, code: "END-ODBR-JT9" },
    { serialNumber: 91, code: "END-IT93-IAO" }, { serialNumber: 92, code: "END-847C-ZZE" }, { serialNumber: 93, code: "END-7FER-PYV" }, { serialNumber: 94, code: "END-21VL-ZPH" }, { serialNumber: 95, code: "END-QOG8-HQM" },
    { serialNumber: 96, code: "END-22YE-MT3" }, { serialNumber: 97, code: "END-8YMW-KSK" }, { serialNumber: 98, code: "END-TYD6-C8P" }, { serialNumber: 99, code: "END-JEBC-H5O" }, { serialNumber: 100, code: "END-11RC-WZY" }
];
...
const seedAllBatches = async () => {
    try {
        ...
        const image3 = '/images/CREME TSHIRT DC.png';

        const finalCodes = [
            ...batch1Codes.map(c => ({ ...c, batchId: 1, image: image1, type: 'Rare' })),
            ...batch2Codes.map(c => ({ ...c, batchId: 2, image: image2, type: 'Rare' })),
            ...batch3Codes.map(c => ({ ...c, batchId: 3, image: image3, type: 'Rare' }))
        ];

        await RedemptionCode.insertMany(finalCodes);
        console.log(`Successfully seeded ${finalCodes.length} codes across 3 batches.`);
